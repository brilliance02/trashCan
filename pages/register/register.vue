  ...
  <view class="content">
    ...
    <uni-forms ref="form" :modelValue="formData" :rules="rules" class="form">
      <uni-forms-item  name="account" >
        <uni-easyinput prefixIcon="person" type="text"  v-model="formData.account" placeholder="请设置账号" />
      </uni-forms-item>
      <uni-forms-item  name="password" >
        <uni-easyinput prefixIcon="locked" type="password" v-model="formData.password" placeholder="请设置密码"></uni-easyinput>
      </uni-forms-item>
    </uni-forms>
